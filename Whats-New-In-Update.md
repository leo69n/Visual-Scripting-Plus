...
<p> . Join in Group Channel : rename to [Join in Voice Channel] , can join in 1 voice channel at the same time only. Must leave the Current Voice Channel before you want to join in another Voice Channel </p>
...
<p> <b>+ Macro-UnityLobby : (***REMAKE) </b> </p> 
<p> . Rename Macro-Lobby to Macro-UnityLobby </p>
<p> . Use different Matching (not same Unity Service, but better) </p>
<p> . Easier to use </p>

<p> <b>+ Macro-UnityRelay : </b> </p> 
<p> . Rename Macro-Relay to Macro-UnityRelay </p>
...
<p> .  Fixed initial Start-Rotate   </p>
...
<h2>***Update Version : 1.058 ( On Unity Asset Store July 22, 2022 ) : </h2>
...
<p> - After Running : to add Animation Run-To-Stop </p>
...
<p> . 2D - Create New Bullet & Fire to Position: With Destroy conditions + Flexible Angles  </p>
<p> . UI - Create New Bullet & Fire to Position : With Destroy conditions + Flexible Angles  </p>
...
<p>   . System-RestartScene : Restart the current Scene  </p>
